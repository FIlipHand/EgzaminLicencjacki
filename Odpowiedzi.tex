	...
	\chapter{Pytania - dr. hab. Bogdan Księżopolski}
		...
		\section{Sieci i programowanie sieciowe}
			...
			\begin{enumerate}
				...
				geograficznej
			\end{enumerate}
			\newpage\subsection{\color{green} Rafał \color{red}Modele sieci komputerowych.}
				a
			\newpage\subsection{\color{green} Rafał \color{red}Porównanie protokołów IPv4 i IPv6.}
				a
			\newpage\subsection{Format pakietu IP (poszczególne pola, zastosowanie).}
				...
				\end{description}
			\newpage\subsection{\color{green} Rafał \color{red}Ethernet.}
				a
			\newpage\subsection{\color{green} Rafał \color{red}Protokoły warstwy aplikacji.}
				a
